  ...
  module AttachmentFu # :nodoc:
    ...
    module ActMethods
      ...
      def has_attachment(options = {})
        ...
        #added 2008.11.21----use for automately different kinds of upload files
        define_format_method(options[:format]) unless options[:format].blank?
      ...
      #added 2008.11.21----use for automately different kinds of upload files
      def define_format_method(partern)
        define_method("filename_partten") do; partern; end
      end
