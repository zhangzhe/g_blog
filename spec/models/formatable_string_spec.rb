...
describe FormatableString do
  describe "to_html_format" do 
    it "should call it's subclasses and format itself to html format(FIXME)" do
      ...
      string.to_html_format.should == "<b>b</b>c<br/>\n\r<ul><li>11</li><li>22</li></ul>aa<span style=\"font-size:17px\">bb</span>cc<font color='#FF0000'>r</font><img style=\"float\" src=\"www.gary.com\"><a target=\"_blank\" style=\"color:#2828FF\" href=www.gary.com>gary</a>"
    end 
  end
end
...
describe FontColorString do
  describe "format" do 
    it "should format font color" do
      ...
      font_color_string.format.should == "<font color='#01DF01'>g</font><font color='#FF0000'>r</font><font color='#0000FF'>b</font>"
    end 
  end
end
